                ...
                <div className = 'flex flex-col gap-8 pt-10 w-[900px]'>
                    <nav className="flex flex-row gap-10 w-full ">
                        ...
                        <div className="relative flex flex-1" >
                            <input type="text" className="bg-[#5EA4A4] rounded-md outline-none px-10 text-sm w-full " placeholder="Search Questions..."/>
                            <IoSearchOutline className="absolute top-1/3 left-3"/>
                        </div> 
                    </nav>
                    <div className="flex items-center  ">
                        <span className="flex-none [font-family: Inter] font-mono text-white w-36 ">Status</span>
