...
export const StatusDropDownMenu = () => {
  ...
  return (
    ...
    >
      <div
        className="text-white font-normal hover:bg-hover flex gap-3 items-center px-2 py-2 w-[90%] rounded-md text-md z-0"
        // onClick={() =>
        //   dispatch(
      ...
      <div
        className="text-white font-normal hover:bg-hover flex gap-1 items-center px-1 py-2 w-[90%] rounded-md text-md z-0"
        // onClick={() =>
        //   dispatch(
      ...
      <div
        className="text-white font-normal hover:bg-hover flex gap-2  items-center px-2 py-2 w-[90%] rounded-md text-md"
        // onClick={() =>
        //   dispatch(
