...
export const DifficultyDropDownMenu = () => {
  ...
  return (
    <div className={`flex flex-col bg-[#2B2A2B] absolute bottom-0 left-0 right-0 top-[110%] h-[125px] items-center rounded-lg py-2 z-10 shadow-md text-sm ${openDropDownMenu.isDifficultyMenuOpen ? "transform translate-y-0 opacity-100" : "translate-y-[-50%] opacity-0"} ease-in-out duration-300`} >
