...
const submission_1 = require("../db/submission");
...
router.get("/get-submissions", auth_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { userAuthorized, userId } = req;
    if (!userAuthorized) {
    ...
    try {
        const user_sumbissions = yield (0, submission_1.getUserSubmissions)(userId);
