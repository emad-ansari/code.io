		...
		<section className="container mx-auto px-6 text-center relative">
			...
			>
				...
				<p className="text-lg md:text-xl text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
					The ultimate platform for developers to solve challenges,
					learn system design, and prepare for top-tier tech
					interviews.
				</p>
				<div className="flex flex-col sm:flex-row items-center justify-center gap-4">
					<button
						className="w-full sm:w-auto bg-white text-brand-bg px-8 py-4 rounded-2xl font-bold text-lg hover:bg-slate-200 transition-colors flex items-center justify-center gap-2 group"
					...
					<button
						className="w-full sm:w-auto glass-card px-8 py-4 rounded-2xl font-bold text-lg hover:bg-white/10 transition-colors"
