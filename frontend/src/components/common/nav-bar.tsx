			...
			<div className="glass-card rounded-full px-6 py-3 flex items-center justify-between">
				...
				{ isLoggedIn && user ? (
					...
					<div className="flex items-center gap-4">
						...
						<button
							className="bg-gradient-to-r from-brand-primary to-brand-secondary text-white px-5 py-2 rounded-full text-sm font-bold shadow-lg shadow-brand-primary/25 hover:scale-105 transition-transform active:scale-95"
