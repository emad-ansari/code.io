...
import { CustomPagination } from "@/pages/ProblemsetPage";
						...
						{users.map((user) => (
							...
							>
                                ...
                                <TableCell className="text-center text-slate-300">
									<span className={` rounded-full px-2 py-1 ${user.role == 'admin' ? "bg-orange-500/10 text-orange-500" : "bg-blue-500/10 text-blue-500"} `}>{user.role}</span>
								</TableCell>
